...
if __name__ == '__main__':
    user_url = "http://20.243.27.243:8080/users"
    data_url = "http://20.243.27.243:8080/data"
    speed_url = "http://20.243.27.243:8080/speed"
    power_url = "http://20.243.27.243:8080/power"

    can_status_url = "http://20.243.27.243:8080/version/status?name=can"
    ota_status_url = "http://20.243.27.243:8080/version/status?name=hhtd24"
